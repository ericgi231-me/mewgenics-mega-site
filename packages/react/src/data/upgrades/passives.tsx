...
export const PASSIVE_OBJECTS: GameObject[] = [
  {
    name: "Avenger",
    icon_path: "/assets/upgrades/passives/ABILITY_Avenger.svg",
  ...
  {
    name: "Boned",
    icon_path: "/assets/upgrades/passives/ABILITY_Boned.svg",
  ...
  {
    name: "Dual Wield",
    icon_path: "/assets/upgrades/passives/ABILITY_Dual_Wield.svg",
