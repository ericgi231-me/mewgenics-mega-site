...
const COLLARLESS_PASSIVE_OBJECTS: GameObject[] = [
  {
    name: "Avenger",
    icon_path: "/assets/passives/collarless/ABILITY_Avenger.svg",
  ...
  {
    name: "Boned",
    icon_path: "/assets/passives/collarless/ABILITY_Boned.svg",
  ...
  {
    name: "Dual Wield",
    icon_path: "/assets/passives/collarless/ABILITY_Dual_Wield.svg",
